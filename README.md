...
| 版本 | 下载 | 说明 |
|------|------|------|
| **安装包** | [Setup.exe](https://github.com/xiaohu-crypto/meidiantong-workbench/releases/download/v0.1.0/Setup.exe) | 推荐，支持自动更新 |
| **便携版** | [Portable.exe](https://github.com/xiaohu-crypto/meidiantong-workbench/releases/download/v0.1.0/Portable.exe) | 免安装，直接运行 |

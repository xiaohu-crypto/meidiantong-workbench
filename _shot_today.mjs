...
(async () => {
  ...
  await p.evaluate(() => window.dispatchEvent(new CustomEvent('nav', { detail: 'today' })));
  await p.waitForTimeout(2000);
  await p.screenshot({ path: 'ui-design-runs/深度提炼媒电通工作台AP-20260925-105929-4c9f/shots/v28_today.png' });
  await b.close();
  console.log('done');
})();
